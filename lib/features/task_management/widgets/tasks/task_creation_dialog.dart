...
class _TaskCreationDialogState extends State<TaskCreationDialog> {
  ...
  void initState() {
    super.initState();
    _selectedListId = widget.preselectedListId ?? widget.controller.selectedListId;
  ...
  Widget build(BuildContext context) {
    if (widget.controller.lists.isEmpty) {
      return AlertDialog(
        ...
        content: const Text('Você precisa criar uma lista primeiro antes de adicionar tarefas.'),
        actions: [
          TextButton(
