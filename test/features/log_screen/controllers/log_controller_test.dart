...
void main() {
  group('LogController Basic Tests', () {
    ...
    test('should handle log deserialization', () {
      // Test Log fromMap method
      final map = {
        'id': 'test_log_4',
        'entityId': 'task_4',
        'entityType': 'task',
      ...
      final log = Log.fromMap(map, 'test_log_4');
  ...
  group('LogController Error Handling Tests', () {
  ...
  group('LogController Utility Tests', () {
    ...
    test('should handle log duration calculation', () {
      // Test duration calculation
      final startTime = DateTime.now();
      final endTime = startTime.add(Duration(minutes: 30, seconds: 45));
